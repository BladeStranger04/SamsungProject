package com.eninkopylov.WriteHealRepeat.db;
...
import com.eninkopylov.WriteHealRepeat.ui.dashboard.HistoryItem;
import com.eninkopylov.WriteHealRepeat.ui.home.HomeItem;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "WHR";
    ...
    public void insertNewMedicine(String medicineName, int day, int month, int year, int noOfTimesPerDay, int totalDoses, String timings, String alertType) {
        ...
        db.insertWithOnConflict(DB_TABLE, null, values, SQLiteDatabase.CONFLICT_REPLACE);db.close();
    }
    ...
    public List<HomeItem> getMedicineList() {
        ...
        while (cursor.moveToNext()) {
            HomeItem homeItem = new HomeItem(cursor.getString(0)  , cursor.getString(1) + " раз в день");
    ...
    public List<String> getTimings(String medicineName) {
        ...
        JSONArray items = json.optJSONArray(" ");
